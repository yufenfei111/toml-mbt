...
发布状态：Workbench [`yufenfei111/toml-mbt@0.2.0`](https://mooncakes.io/docs/yufenfei111/toml-mbt) 已于 2026-08-21 发布，并已在全新临时项目中通过 `moon add yufenfei111/toml-mbt@0.2.0`、依赖树解析和 `moon check`。
